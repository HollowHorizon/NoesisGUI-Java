...
public class NSColumnDefinitionCollection extends NSUICollection{

    public NSColumnDefinitionCollection(long ptr) {
        super(ptr);
    }
     ...
     */
    public final NSColumnDefinition get(final int index) {
        return new NSColumnDefinition(nGet(getPtr(), index));
    }

    /**
     * Sets the element at the specified index
     */
    public final void set(final int index, final NSColumnDefinition item) {
     ...
     */
    public final void add(final NSColumnDefinition item) {
     ...
     */
    public final void insert(final int index, final NSColumnDefinition item) {
     ...
     */
    public final boolean contains(final NSColumnDefinition item) {
     ...
     */
    public final int indexOf(final NSColumnDefinition item) {
     ...
     */
    public final boolean remove(final NSColumnDefinition item) {
