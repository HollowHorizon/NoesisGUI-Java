...
public class NSInputBindingCollection extends NSUICollection{

    public NSInputBindingCollection(long ptr) {
        super(ptr);
    }
     ...
     */
    public final NSInputBinding get(final int index) {
        return new NSInputBinding(nGet(getPtr(), index));
    }

    /**
     * Sets the element at the specified index
     */
    public final void set(final int index, final NSInputBinding item) {
     ...
     */
    public final void add(final NSInputBinding item) {
     ...
     */
    public final void insert(final int index, final NSInputBinding item) {
     ...
     */
    public final boolean contains(final NSInputBinding item) {
     ...
     */
    public final int indexOf(final NSInputBinding item) {
     ...
     */
    public final boolean remove(final NSInputBinding item) {
