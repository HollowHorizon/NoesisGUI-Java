...
public class NSRowDefinitionCollection extends NSUICollection{

    public NSRowDefinitionCollection(long ptr) {
        super(ptr);
    }
     ...
     */
    public final NSRowDefinition get(final int index) {
        return new NSRowDefinition(nGet(getPtr(), index));
    }

    /**
     * Sets the element at the specified index
     */
    public final void set(final int index, final NSRowDefinition item) {
     ...
     */
    public final void add(final NSRowDefinition item) {
     ...
     */
    public final void insert(final int index, final NSRowDefinition item) {
     ...
     */
    public final boolean contains(final NSRowDefinition item) {
     ...
     */
    public final int indexOf(final NSRowDefinition item) {
     ...
     */
    public final boolean remove(final NSRowDefinition item) {
